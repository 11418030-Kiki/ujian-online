...
<div class="container">
	<div class="panel panel-default"  style="margin-left:80px;margin-right:80px;">
				<div class="panel-heading">
					<h3 style="margin-left:0px;margin-top:-6px;">Insert Data Siswa</h3>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-2"  for="nip">Nomor Induk</label>
						<div class="input-group">
						    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;</span>
						    	<input type="number" class="form-control" name="nip" placeholder="Masukkan Nomor Induk " required="required" >
						</div> 
				...
				<div class="form-group">
					<label class="col-sm-2"  for="nip">NISN</label>
						<div class="input-group">
						    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;</span>
						    	<input type="number" class="form-control" name="nip" placeholder="Masukkan Nomor Induk Siswa Nasional" required="required" >
						</div> 
						<span style="margin-left:240px;"></span>          
				</div>	
